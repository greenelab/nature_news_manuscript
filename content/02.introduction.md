...
We used computational methods to predict gender and identified a trend towards quotes from persons predicted male in journalism when compared to both the general population and predicted male authorship in academic research articles.
...
While we focused on journalism from _Nature_, our software can be repurposed to analyze other text.
