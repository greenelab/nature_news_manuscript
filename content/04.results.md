...
We observed significant variability in the number of _Nature_ news-articles by type between 2005 and 2020 (Figure {@fig:fig1}b).
...
To extend our analysis to primary research authors more broadly, we also examined a random selection of authors from English language journals published by _Springer_ (Figure {@fig:suppfig2}a). The predicted gender gap between first and last authors was larger in our selection of _Springer_ articles; however, both first and last authors were predicted to be closer to parity than for _Nature_ authors.
...
To identify possible biases in name origin, we again used the extracted names of quoted speakers and last authors published in _Nature_.
...
However, we did observe that European name origins were more highly cited in articles written by scientists than journalists (Figure {@fig:suppfig4}4b,c).
