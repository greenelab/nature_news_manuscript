...
We found that differences between journalists with different predicted name origins was nearly eliminated when restricting to quoted speakers with a US affiliated citation, as evidenced in the predicted East Asian column of Table {@tbl:table7}.
