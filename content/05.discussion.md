...
We found that journalists with a predicted East Asian name origin quote a higher proportion of predicted East Asian quotes, in comparison for journalists with European or Celtic English predicted names.
This could suggest that having journalists either focused on specific gegographical regions or co-located with a region of interest could increase geographic diversity in scientific representation.
...
However, having reporters explicitly biased towards regional sources to better cover international opinions in science, can help ameliorate this disparity.
