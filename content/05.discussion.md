...
This is a major limitation, because the only measures that we have of demographics of sources are persons who have their name mentioned within the article or cited in the article.
This is only one aspect of the journalistic research process; a journalist may talk to several diverse persons, read their work, but not cite or mention them for several possible reasons.
For example, a person may not be directly included in the article because of journalisitc style, that a person does not want to be included, or that they only provide informational content that is not directly quotable, but instead shapes the content of the article.
A more accurate reflection of journalists' sources would be a self-maintained record of persons they interview, to ensure any bias is limited.
However, it is still useful to identify possible biases in which demographics tend to receive more recognition within journalistic output, which can be measured by mentions, quotes, or citations of persons.

Furthermore, many journalists are limited by the persons who can respond to their requests for an interview or leads from prominent scientists.
...
Journalists and referee scientists have a unique opportunity to shape the public and their peers' perspectives on who is a scientific expert.
Their choice of coverage topics and interviewees could help to diminish possible biases in scientific journalism.
