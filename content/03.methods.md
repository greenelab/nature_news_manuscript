...
The Springer API was used to generate a comparative background set for supplemental analyses and to obtain the authors' information for research articles cited in the news.
