...
If so, we assign the gender of the pronoun to the speaker.
...
This processing was not required for quote prediction because we names written in news articles did not appear to be reversed or abbreviated.
