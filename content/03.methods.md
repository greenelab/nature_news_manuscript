...
$$\textrm{Prop. Colombia Citations} = \frac{|\textrm{Articles with} \geq 1 \textrm{ Colombia affiliation}|} {|\textrm{All Articles Cited in News}|}$${#eq:mention-news}
...
News articles in 2020 were not considered due to an excess of SARS-CoV-2 related terms.
